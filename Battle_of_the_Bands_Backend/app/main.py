...
async def startup():
    await init_db()
    # Background sweep that frees memory held by finished/abandoned match
    # rooms. Fire-and-forget: it runs for the lifetime of the process, so
    # there's nothing to await here, just kick it off.
