...
async def stripe_webhook(
    ...
    if event_type in ("customer.subscription.created", "customer.subscription.updated"):
        ...
        if user:
            ...
            # As of API version 2026-05-27.dahlia, current_period_end lives on each
            # subscription item, not on the top-level Subscription object. Also note
            # StripeObject does not implement dict's .get() — use indexing/try-except.
            try:
