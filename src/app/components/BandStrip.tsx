...
const BAND_SETS: Partial<Record<Genre, BandMember[]>> = {
  Rock: [
    { id: "guitarist", src: rockGuitarist, staticSrc: rockGuitaristStill, w: 263, h: 504, style: "strum", origin: "50% 100%" },
    { id: "drummer", src: rockDrummer, staticSrc: rockDrummerStill, w: 384, h: 383, style: "drum", origin: "50% 75%" },
    { id: "singer", src: rockSinger, staticSrc: rockSingerStill, w: 246, h: 469, style: "sing", origin: "50% 100%" },
    { id: "bassist", src: rockBassist, staticSrc: rockBassistStill, w: 253, h: 458, style: "strum", origin: "50% 100%" },
  ],
};
...
const TARGET_HEIGHT = 336; // px, height of the tallest (standing) member (doubled)
...
export function BandStrip({ genre, bpm, isRecording, recordingSignature, teamSize }: Props) {
  ...
  return (
    <div
      className="mt-3 flex items-end justify-center gap-8 sm:gap-16 pointer-events-none select-none"
