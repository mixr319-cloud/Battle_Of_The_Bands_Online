  ...
  useEffect(() => {
    const unsub = onMessage((msg) => {
      if (msg.type === "queued") {
        ...
        if (msg.stalled) {
          setNpcWarning(true);
          setStatus("Still waiting for someone on the other team — hang tight...");
        } else {
    ...
    // If after 20s we haven't started, show multi-turn warning
    const t = setTimeout(() => {
      setNpcWarning(true);
      setStatus("Couldn't find enough players — some players will take multiple turns!");
    }, 20000);
    ...
    <div className="size-full flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        {npcWarning && (
          ...
          >
            Not enough players found — each player will take multiple turns!
          </motion.div>
        )}
