...
export function ProfileIcon({ profile, onLogout }: Props) {
  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.93 }}
        className="fixed top-4 left-4 z-50 w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-lg"
        style={{
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="rounded-xl p-3 mb-4 text-center"
                  ...
                  <p className="text-purple-400/60 text-xs">🎨 Cosmetics coming soon</p>
                </div>
