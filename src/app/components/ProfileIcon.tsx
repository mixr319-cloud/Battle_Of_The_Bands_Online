  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-4 z-50">
        <PremiumAvatarFrame isPremium={profile.isPremium} rounded="rounded-full">
          <motion.button
            onClick={() => setOpen(true)}
            whileHover={{ scale: 1.08 }}
            whileTap={{ scale: 0.93 }}
            className="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-lg overflow-hidden"
            style={{
              ...
              <div className="p-5">
                ...
                <div className="flex items-start justify-between mb-5">
                  <div className="flex items-center gap-3">
                    <PremiumAvatarFrame isPremium={profile.isPremium} rounded="rounded-xl">
                      <div
