...
export function ResultsScreen({ teams, winner, votes, mvp, recordings, onPlayAgain, xpSaveWarning }: Props) {
            ...
            <div className="rounded-2xl p-5"
              ...
              <div className="space-y-3">
                {[...teams.A.players, ...teams.B.players].map(player => {
                  ...
                  const earnedXp: number = (player as Record<string, unknown>).earnedXp as number ?? totalXp;
                  const xpBefore = earnedXp === totalXp && !(player as Record<string, unknown>).earnedXp
