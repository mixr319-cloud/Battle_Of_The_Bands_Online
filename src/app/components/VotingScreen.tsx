...
export function VotingScreen({ teams, recordings, myPlayerId, send, matchId, onMessage, timeoutSecs = 30 }: Props) {
  ...
  return (
    <div className="relative size-full flex flex-col items-center justify-center px-6 overflow-y-auto py-8">
      ...
      <StageCharacter character="bassist" side="left" width={690} className="hidden lg:block opacity-40 grayscale-[20%]" />
      <StageCharacter character="guitarist" side="right" width={690} className="hidden lg:block opacity-40 grayscale-[20%]" />
